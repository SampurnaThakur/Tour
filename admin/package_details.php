    ...
    <div class="popup popup--icon -question js_question-popup popup--visible">
        ...
        <div class="popup__content">
            <h3 class="popup__content__title">
                ...
                <p>
                    <a href="operations/packages.php?id=<?php echo $_GET['id']; ?>" class="button button--success"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="add_packages.php"><button type="button" class="btn btn-primary">Add Package
                                Details</button></a>
                                    ...
                                    foreach ($data as $value) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <?php echo $value['price_adult']; ?>
                                            </td>
                                            <td style="text-align: center;">
                                                <?php echo $value['price_children']; ?>
                                            </td>



                                            <td><a href="package_details.php?id=<?php echo $value['id']; ?>"
                                                    class="btn btn-xs btn-danger"><i class="fa fa-trash fa-2x"
                                                        data-toggle="tooltip" title="Delete"></i></a>
                                                <a href="update_packages.php?id=<?php echo $value['id']; ?>"
